...
- **feature/**: New features (e.g., `feature/wallet-api`)
- **fix/**: Bug fixes (e.g., `fix/balance-calculation`)
- **refactor/**: Code refactoring

All changes require:
1. Feature branch created from `main`
2. Pull request with descriptive title
3. Code review and approval
4. Merge to `main` (squash merge preferred)

## Challenge Requirements Checklist

All ília NodeJS Challenge requirements implemented:

**Part 1: Wallet Microservice** ✓
- Digital wallet with transaction storage ✓
...
**Part 2: Users Microservice & Integration** ✓
- User management microservice ✓
- HTTP Request handling (REST API) ✓
- Dedicated PostgreSQL database (port 5433) ✓
- JWT authentication with `ILIACHALLENGE` secret ✓
- Running on port 3002 ✓
- Internal communication security (JWT with `ILIACHALLENGE_INTERNAL`) ✓
- RESTful inter-service communication ✓
- Docker containerization ✓

**Best Practices** ✓
- Gitflow with pull requests and code reviews ✓
- Project documentation (this README + DEVELOPMENT.md) ✓
- Environment variable configuration ✓
- Unit and integration tests ✓

---

Built for the [ília Digital Code Challenge](https://github.com/ilia-development/code-challenge-nodejs) with production-grade architecture and pragmatic engineering decisions.
